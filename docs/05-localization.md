...
The generated `S` class lives there, and the analyzer flagged it
heavily — `intl` imports, missing type annotations, lint rules the
generator doesn't follow. None of that is fixable by hand,
