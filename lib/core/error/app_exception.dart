...
///
/// Split by what each case carries: only a refusal from the server has a
/// status code, so only [ServerException] holds one.
...
/// The server answered and refused, so [statusCode] is always a real one.
...
/// One code for every table: the screen has nothing different to say about
/// which one failed.
